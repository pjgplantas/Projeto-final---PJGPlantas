  ...
  <b-container>
    ...
    <b-row>
      <b-col class="col1">
        ...
        <div>
          <b-form-input placeholder="Insira seu CPF:"></b-form-input>
        </div>
        ...
        <div>
          <b-form-input  placeholder="Insira seu CEP:"></b-form-input>
        </div>
      ...
      <b-col class="col2">
        ...
        >
          ...
          <b-dropdown-item>PIX</b-dropdown-item>
